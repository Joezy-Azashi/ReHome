...
import { columns } from '../../pages/agents/SalesTableHead'
    ...
    return (
        <>
            <Box sx={{ display: {xs: 'block', sm: 'flex'}, flexDirection: 'row', justifyContent: 'end' }}>
                ...
                <Box mb={4} mx={2.1} sx={{ display: "flex", justifyContent: "end" }}>
                    <RoundButton onClick={() => navigate('/admin/add-customer-search')} text={t('admindashboard.salesdb.add')} disableElevation variant={'contained'} sx={{ padding: '.5rem 1.5rem' }} />
                </Box>
            </Box>
